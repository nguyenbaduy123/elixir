defmodule PassGenerator do
  ...
  The option are only 4, `length`, `numbers`, `uppercase`, `symbols`
  """
  ...
  defp validate_options_values_are_boolean(false, _length, _options) do
    {:error, "Only boolean allowed for options values"}
  end
  ...
  defp validate_options(true, _length, _options) do
    {:error, "Only option allowed numbers, uppercase and symbols."}
  end
